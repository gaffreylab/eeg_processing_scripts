...
proj.erp_filenames = dir(fullfile(proj.data_location, '*.txt'));
proj.erp_filenames = {proj.erp_filenames(:).name};

proj.data_location2 = 'E:\new_go_prep\processed_data_new\flags\';
proj.erp_filenames2 = dir(fullfile(proj.data_location2, '*.txt'));
...
writetable(summary_tab, [proj.output_location filesep 'reaction_time_data.csv']);
