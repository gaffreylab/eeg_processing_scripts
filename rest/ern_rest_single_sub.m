% ********************************************************************** %
% Preprocessing Script for ERN Resting State EEG Data
% Authors: Armen Bagdasarov (Graduate Student) & 
%          Kenneth Roberts (Research Associate)
% Institution: Duke University
% ********************************************************************** %

% Run loop script to run this function.

function summary_info = ern_rest_single_sub(varargin)
...
% Otherwise, sometimes an error is produced (not sure why, does not matter)
...
% Save length of data as an additional check (240 = 4 minutes)
...
if isempty(EEG.chaninfo.removedchans) % If no bad chans...
    ...
    bad_chan_plot_path = 'E:\resting_for_ern\eyes_closed\preprocessed_data\processed_new\1_bad_chans\'; 
    bad_chan_plot_name = [proj.currentId '_rest_for_ern_bad_chans'];
...
% Save ICA plot
ica_plot_path = 'E:\resting_for_ern\eyes_closed\preprocessed_data\processed_new\2_ica\'; 
ica_plot_name = [proj.currentId '_rest_for_ern_ica'];
...
ica_rej_plot_path = 'E:\resting_for_ern\eyes_closed\preprocessed_data\processed_new\3_removed_ics\'; 
...
spectra_plot_path = 'E:\resting_for_ern\eyes_closed\preprocessed_data\processed_new\4_chan_spectra\'; 
spectra_plot_name = [proj.currentId '_rest_for_ern_cchan_spectra'];
...
% in .set format
set_path = 'E:\resting_for_ern\eyes_closed\preprocessed_data\processed_new\5_complete_set\'; 
set_name = [proj.currentId '_rest_for_ern_complete'];
